...
Bundle portable chính thức 0.23.8 đang được đóng gói có các phiên bản thực tế:
...
Các phiên bản trên được lấy trực tiếp từ output `rtabmap-export.exe --version`
và metadata ProductVersion của `OrbbecSDK.dll`. Đáng chú ý, OpenCV và PCL khác
với kỳ vọng từ release note/thiết kế của 0.23.8 (OpenCV 4.13.0 và PCL 1.15.0);
phiên bản thực tế trong bundle portable là nguồn thông tin chính xác khi vận hành.
